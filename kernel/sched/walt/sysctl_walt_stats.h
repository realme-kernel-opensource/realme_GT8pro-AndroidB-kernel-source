...
extern void update_min_max_freq_ns(struct waltgov_policy *wg_policy, u64 time);
...
static inline void update_min_max_freq_ns(struct waltgov_policy *wg_policy, u64 time) { }
