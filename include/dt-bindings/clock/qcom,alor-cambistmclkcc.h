...
#ifndef _DT_BINDINGS_CLK_QCOM_CAM_BIST_MCLK_CC_ALOR_H
#define _DT_BINDINGS_CLK_QCOM_CAM_BIST_MCLK_CC_ALOR_H
...
#define CAM_BIST_MCLK_CC_PLL0					14
#define CAM_BIST_MCLK_CC_PLL_TEST_CLK				15
#define CAM_BIST_MCLK_CC_PLL_TEST_DIV_CLK_SRC			16
