...
static int __battery_psy_set_charge_current(struct qcom_battmgr *battmgr, u32 fcc_ua)
{
	int ret;
...
static int battery_psy_set_charge_current(struct qcom_battmgr *battmgr, int val)
{
...
static int qcom_battmgr_chg_get_max_charge_cntl_limit(struct thermal_cooling_device *tcd,
					   unsigned long *state)
{
...
static int qcom_battmgr_chg_get_cur_charge_cntl_limit(struct thermal_cooling_device *tcd,
					   unsigned long *state)
{
	struct qcom_battmgr *battmgr = tcd->devdata;
...
static int qcom_battmgr_set_cur_charge_cntl_limit(struct thermal_cooling_device *tcd,
				       unsigned long state)
{
	struct qcom_battmgr *battmgr = tcd->devdata;
