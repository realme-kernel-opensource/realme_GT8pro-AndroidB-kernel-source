...
static void __maybe_unused zram_copy_success_handler(struct qpace_event_descriptor *ed, int ed_index)
{
...
static void __maybe_unused zram_copy_failure_handler(struct qpace_event_descriptor *ed, int ed_index)
{
	struct qpace_request_data *zdata = &copy_out_queue.request_arr[ed_index].zdata;
	struct qpace_request_meta *zmeta = zdata->zmeta;
